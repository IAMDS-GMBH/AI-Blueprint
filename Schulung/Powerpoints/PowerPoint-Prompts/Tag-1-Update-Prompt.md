...
Falls die Folie noch generische LLM-Eigenschaften zeigt, ersetze durch:
- **Kosten-Tabelle:**
...
- Kernaussage: "KI kennt das Pattern, aber nicht EUER Projekt."
...
- **OHNE KERNEL:** "Hilf mir eine Spring-App zu bauen" → generisches Hello-World
- **MIT KERNEL:** Context/Task/Constraints/Format → vollständiger UserController + Service mit BCrypt, @Valid, Interface-Pattern
...
### Letzte Folie: "Zusammenfassung Tag 1" (ANPASSEN)
- Key Takeaways:
