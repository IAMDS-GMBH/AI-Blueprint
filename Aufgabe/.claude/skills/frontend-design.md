---
description: Wird geladen wenn Vue.js Komponenten aus Design-Vorgaben, Screenshots, Figma-Beschreibungen oder UI-Anforderungen generiert werden sollen. Angepasste Version des Anthropic Frontend Design Skills fuer Vue.js 3.
applyTo: "**/*.vue"
---

# Skill: Frontend Design (Vue.js 3)

Basiert auf dem offiziellen Anthropic Frontend Design Skill, angepasst fuer unseren Vue.js 3 Stack.
...
<template>
  <!-- Semantisches HTML, Accessibility beachten -->
  <button
    :class="classes"
